...
**實際工作範圍 = 200 - 4 = 196 篇**（扣掉 4 篇 meta / pure-links 不該動的，見下節）。

196 篇都該做 — 哲宇親口認的「品質堪憂」。我們分四個 priority 階段執行，**不是 cherry-pick 子集，是順序問題**。
...
├── P1 (19%) — 0 footnote + 80-119 行  → 38 篇 → 實際 37 (扣緣起故事)
...
### P1 — 37 篇（5/12 baseline 核對完成，未開動）

> 原始 P1 38 篇，扣掉 `About/緣起故事` 1 篇 meta 後實際工作 37 篇。
...
**特性**：跟 P0 對比，**主題多元化**。People 比例從 93% 降到 30%，Economy 企業類 (7 篇) 是新主戰場。Society / History 議題類比例上升 (5 篇 = 14%)。
...
**已 ship 比例**：44 / 196 = 22.4%（用實際工作範圍 196 計算）
**剩餘**：P1 37 + P2 95 + P3 20 = **152 篇待處理**
